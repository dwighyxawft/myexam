...
<meta charset="UTF-8">
    ...
    <title>Xawft Quiz // User Account</title>
</head>
<body>
<header>
            ...
            <div class="w-50 mx-auto mt-5">
                <div class="card">
                    <div class="card-header">
                        <img src="images/<?php echo $row["user_image"];?>" alt="" class="card-img-top img-thumbnail">
                    </div>
                    <div class="card-body ps-3">
                        <h4 class="pt-4"><?php echo $row["user_name"];?></h4>
                        <h5 class="pt-5"><?php echo $row["user_email"];?></h5>
                        <h4 class="pt-4"><?php echo $row["user_address"];?></h4>
                        <h3 class="pt-3"><?php echo $row["user_mobile"];?></h3>
                        <h6 class="pt-2"><?php echo $row["user_gender"];?></h6>
                    </div>
                   ...
                   <form method="post" id="edit_account"> <div class="modal-header">
                    ...
                    <div class="modal-body pt-3">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="tel" name="mobile" id="mobile" class="form-control" value="<?php echo $row["user_mobile"];?>" required>
                        </div>
                        <div class="form-group mb-2">
                            <label>Address:</label>
                            <input type="text" name="address" id="address" class="form-control" value="<?php echo $row["user_address"];?>" required>
                        </div>
                        <div class="form-group mb-2">
                            <label>Gender:</label>
                ...
                <div class="modal-content">
                   <form method="post" id="chg_pass_form"> 
                    ...
                    <div class="modal-body pt-3">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="page" class="form-control" value="user">
                ...
                <div class="modal-content">
                   <form method="post" enctype="multipart/form-data" action="edit_image.php"> <div class="modal-header">
                    ...
                    <div class="modal-body pt-3">
                        ...
                        <div class="form-group mb-2">
                           <img src="images/<?php echo $row["user_image"];?>" height="250" alt="No user">
                        </div>
