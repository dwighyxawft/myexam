...
<meta charset="UTF-8">
    ...
    <title>Xawft Quiz // User Enroll Exams</title>
</head>
<body>
<style>
        main{
    ...
    <header>
      ...
      <div class="container">
       <div class="table-responsive">
            <table class="table table-hover table-bordered border-warning mt-5 mb-5">
                <thead>
                    <tr>
        ...
        <?php
                                            $exam->query = "SELECT * FROM exam_table WHERE exam_status = 'Created'";
    ...
    <script>
        $(document).ready(function(){
           ...
           get_exams(0);
           $("button.page_link").click(function(){
            var value = $(this).text();
                var actual = value - 1;
