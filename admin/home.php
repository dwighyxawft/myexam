        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mt-4">
                   <a href="all_exams.php" style="text-decoration: none;">
                   <div class="cards rounded bg-primary">
                        <div class="w-50 bg-light rounded border border-1 border-primary"><h5 class="text-center text-primary py-2">All Exams</h5></div>
                ...
                <div class="col-md-4 mt-4">
                <a href="total_exams.php" style="text-decoration: none;">
                <div class="cards rounded bg-warning">
                        <div class="w-50 bg-light rounded border border-1 border-warning"><h5 class="text-center text-warning py-2">Total Exams</h5></div>
                        <div class="pt-5 pb-2">
                            <div class="row">
                                <div class="col"> <i class="fa fa-list fa-3x ps-3"></i></div>
                                <div class="col d-flex justify-content-end"> <h1 class="cards-text d-inline text-end text-light pe-4">
                                <?php
                ...
                <div class="col-md-4 mt-4">
               <a href="total_examinees.php" style="text-decoration: none;">
               <div class="cards rounded bg-success">
                        <div class="w-50 bg-light rounded border border-1 border-success"><h5 class="text-center text-success py-2">Total Examinees</h5></div>
                        
                        <div class="pt-5 pb-2">
                            <div class="row">
                                <div class="col"> <i class="fa fa-users fa-3x ps-3"></i></div>
                                <div class="col d-flex justify-content-end"> <h1 class="cards-text d-inline text-end text-light pe-4">
                                <?php
                                    $exam->query = "SELECT * FROM user_enroll_exam_table WHERE enroller_id = '$admin_id' OR offerer_id = '$admin_id'";
                                    $total_row = $exam->total_rows();
