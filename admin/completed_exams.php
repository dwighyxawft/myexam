...
<header>
    ...
    <div class="modal fade" id="modal1">
        ...
        <div class="container">
            ...
            <button class="btn btn-md btn-dark bg-dark mt-4" data-bs-toggle="modal" data-bs-target="#modal1">Add Exam</button>
            <div class="table-responsive">
                <table class="table table-bordered border-dark mt-5 mb-5">
                    <thead>
                        <tr>
                            <th>Exam Title</th>
                            <th>Exam Date</th>
