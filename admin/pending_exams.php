...
<header>
    ...
    <div class="modal fade" id="modal1">
        ...
        <div class="container">
            ...
            <button class="btn btn-md btn-warning bg-warning mt-4" data-bs-toggle="modal" data-bs-target="#modal1">Add Exam</button>
            <div class="table-responsive">
                <table class="table table-bordered border-warning mt-5 mb-5">
                    <thead>
                        <tr>
                            <th>Exam Title</th>
                            <th>Exam Date</th>
