...
<header>
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <ul class="navbar-nav nav nav-pills">
                        ...
                        <li class="nav-item ps-2"><a href="about.php" class="nav-link">CONTACT</a></li>
   ...
   <ul class="pagination pagination-md pb-5 pt-4" id="pagin">
       ...
       $exam->query = "SELECT * FROM user_enroll_exam_table WHERE (offerer_id = '$admin_id' OR enroller_id = '$admin_id')";
